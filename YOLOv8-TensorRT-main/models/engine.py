...
class TRTModule(torch.nn.Module):
    ...
    def __init_engine(self) -> None:
        ...
        # Handle both old and new TensorRT API
        if hasattr(model, 'num_bindings'):
            # TensorRT < 10.0 (old API)
            ...
            # TensorRT >= 10.0 (new API)
            num_inputs = 0
            num_outputs = 0
            names = []
            
            # Count inputs and outputs using new API
            ...
            num_bindings = num_inputs + num_outputs
            self.bindings: List[int] = [0] * num_bindings
    ...
    def __init_bindings(self) -> None:
        ...
        # Handle both old and new TensorRT API
        if hasattr(self.model, 'get_binding_name'):
            # TensorRT < 10.0 (old API)
