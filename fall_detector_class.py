...
class FallDetector:
    def __init__(self, rtsp_url, video_file, use_rtsp=False):
        ...
        self.engine_path = "fall.engine"
        self.label_binarizer_path = "./model/fall.pickle"
        self.image_size = 128
    ...
    def _initialize_components(self):
        ...
        try:
            ...
            print(f"[INFO] FallDetector initialized successfully in process {os.getpid()}")
    ...
    def save_clip(self, frame, current_time):
        ...
        try:
            if not self.thumbnail_saved:
                ...
                thumbnail_path = os.path.join(self.output_dir, f"fall_thumbnail_{timestamp_str}.jpg")
    ...
    def cleanup(self):
        ...
        try:
            ...
            print(f"[INFO] FallDetector cleanup completed for process {os.getpid()}")
        except Exception as e:
